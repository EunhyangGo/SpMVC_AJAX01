...
$(function(){
	...
	*/
	$(".d-tr").click(function(){
		...
		// dcode, dname, dceo를 json형식으로 만들어서 배열에 추가
		// dcode, dname, dceo라는 변수를 만든것
		let json data = {d_code:dcode, d_name:dname, d_ceo:dceo}
	...
	$("#btn-send").click(function(){
		...
		*/
		...
		$.ajax({
			...
			data:JSON.stringify(deptList), // 데이터를 json형식으로 서버를 보내라.
