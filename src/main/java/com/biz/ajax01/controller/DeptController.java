...
public class DeptController {
	...
	public String dept_list(Model model) {
		...
		List<DeptVO> deptList = dService.getDeptAllList();
	...
	/*
	 * ajax로 호출된 결과를 return할때
	 * 문자열로 return을 하려면
	 * @ResponseBody를 설정해 주면된다.
	 * 
	 * 그런데 ajax 호출된 결과를 다른 용도로 사용하려면
	 * JSON형태로 return을 해 주는 것이 좋다.
	 * 
	 * 하지만 
	 ...
	 * 통로가 마련되어 있고, 
	 * 한가지의 3rd party library만 설정해주면 된다.
	 */
	@ResponseBody
